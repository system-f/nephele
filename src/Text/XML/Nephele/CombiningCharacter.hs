...
--
-- >>> parse combiningCharacter "test" "abc"
-- Right (CombiningCharacter 'a')
combiningCharacter ::
  CharParsing m =>
...
-- | Parse zero or many combiningCharacters.
combiningCharacters ::
  CharParsing m =>
  m [CombiningCharacter]
combiningCharacters =
...
-- | Parse one or many combiningCharacters.
combiningCharacters1 ::
  CharParsing m =>
